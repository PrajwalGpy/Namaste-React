...
const restObj = [
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-03-08 19:00:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
    ...
    analytics: {
      context: "seo-data-77726539-354a-418f-85ca-0fec2b810be5",
    },
    cta: {
      link: "https://www.swiggy.com/restaurants/new-modern-hotel-parvathipuram-basavanagudi-bangalore-501190",
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-03-08 21:45:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-03-09 00:45:00",
        opened: true,
      },
      badges: {
        textExtendedBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-03-08 18:50:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/airlines-hotel-lavelle-road-bangalore-79234",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
  ...
  },
  {
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/bidadi-thatte-idly-4th-block-jayanagar-bangalore-479256",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        {restObj.map((restotent) => (
          <RestorentCard key={restotent.info.id} restData={restotent} />
        ))}
      </div>
    </div>
  );
